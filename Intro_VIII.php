...
// Create a function called 'multiply()' that reads each value in the array (e.g. $A = array(2, 4, 10, 16)) 
//and returns an array where each value has been multiplied by 5.
